...
////    for (double i = -PI; i < PI*8; i+= 0.40) {
////    	listofshapes.push_back(new Sphere(vec3(-20  - 10*i, 20 *cos(i),  20 * sin(i)), 3, vec3(0, 0, 255)));//Blue Sphere
////    }
//    bluecircle = new Sphere(vec3(-20, 10, 0), 4, vec3(0, 0, 255));
//    listofshapes.push_back(bluecircle);//Blue Sphere
//    listofshapes.push_back(new Sphere(vec3(-20, 10, 20), 3, vec3(0, 255, 0)));//Green Sphere
...
//    unsigned numRays = 20;
//    render(userstartdirection, userstartpoint, listofshapes, numRays, true);
//    return 0;
//}
//
//void outputPictureToFile(vector<vector<vec3>> pixels) {
...
//                    if ((t > 0) && t < lowest_t) {
//                        if(shape == bluecircle){
//                            cout <<"Point: " <<pixelRay.getpoint() << " Dir:" <<pixelRay.getdir() <<endl;
//                        }
